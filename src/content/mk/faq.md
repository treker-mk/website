...
Моментално, само [За проектот](/mk/about) и овие ЧПП страници се преведени. Другите се во план. Во секој случај и програмскиот код и текстот се од отворен пристап (англ. open source) и ако ве интересира да помогнете во преводот тоа може да го направите. Сите [податоци](https://github.com/treker-mk) се означени со ознаки (tag) на англиски јазик, така да меѓународната употреба на сајтот е исто можна. 
