    ...
    return {
      ...
      charts: {
        'metrics-comparison-chart': {
          titleMenu: this.$t('charts.metricsComparison.titleMenu_MKD'),
          icon: 'graph',
        },
        'spread-chart': {
        ...
        'sk-map-chart': {
          titleMenu: this.$t('charts.sk-map.titleMenu'),
          icon: 'map',
        },
        ...
        'sk-municipalities-chart': {
          titleMenu: this.$t('charts.sk-municipalities.titleMenu'),
          icon: 'column',
        },
        'europe-chart': {
